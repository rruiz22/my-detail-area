...
// Note: Workbox caching is configured in vite.config.ts

const CACHE_NAME = 'mda-cache-v1';
const PRECACHE_URLS = ['/'];
...
self.addEventListener('push', (event) => {
  ...
  if (event.data) {
    try {
      console.log('🔔 [SW] Parsing push data...');
    ...
    console.warn('⚠️ [SW] No data in push event - using defaults');
  }

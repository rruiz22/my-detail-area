...
const DetailHubDashboard = () => {
  ...
  const stats = [
    { title: t('detail_hub.dashboard.stats.active_employees'), value: "24", icon: Users, change: "+2", color: "text-blue-600" },
    { title: t('detail_hub.dashboard.stats.todays_hours'), value: "192", icon: Clock, change: "+5%", color: "text-green-600" },
    { title: t('detail_hub.dashboard.stats.pending_reviews'), value: "$12,450", icon: DollarSign, change: "-3%", color: "text-orange-600" },
    { title: t('detail_hub.dashboard.stats.total_revenue'), value: "96%", icon: UserCheck, change: "+1%", color: "text-emerald-600" }
  ];

  const recentActivity = [
    { employee: "John Smith", action: t('detail_hub.toasts.clocked_in'), time: "8:00 AM", status: "success" },
    { employee: "Maria Garcia", action: t('detail_hub.punch_clock.start_break'), time: "10:15 AM", status: "warning" },
    { employee: "Mike Johnson", action: t('detail_hub.toasts.clocked_out'), time: "5:30 PM", status: "success" },
    { employee: "Sarah Wilson", action: t('detail_hub.timecard.status_badges.late'), time: "8:45 AM", status: "error" }
  ];

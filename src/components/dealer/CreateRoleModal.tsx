  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Role "${displayName}" created successfully`
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Click on permission badges to grant access. Selected modules will be accessible to users with this role.
            </p>
          </div>

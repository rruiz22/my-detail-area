...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      detail_hub_breaks: {
        Row: {
          ...
          break_end_address: string | null
          break_end_latitude: number | null
          break_end_longitude: number | null
          break_number: number
          break_start: string
          break_start_address: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "detail_hub_breaks_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_employees_with_faces"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "detail_hub_breaks_time_entry_id_fkey"
      ...
      detail_hub_employee_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "detail_hub_employee_audit_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "detail_hub_employee_audit_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_currently_working"
            referencedColumns: ["employee_id"]
      ...
      detail_hub_employees: {
        Row: {
          ...
          face_enrollment_photo_url: string | null
          face_id: string | null
      ...
      detail_hub_face_enrollment_log: {
        Row: {
          action: string
          created_at: string | null
          dealership_id: number
        ...
        Relationships: [
          {
            foreignKeyName: "detail_hub_face_enrollment_log_dealership_id_fkey"
            columns: ["dealership_id"]
            isOneToOne: false
            referencedRelation: "appointment_slots_health"
            referencedColumns: ["dealer_id"]
          ...
          {
            foreignKeyName: "detail_hub_face_enrollment_log_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_currently_working"
            referencedColumns: ["employee_id"]
      ...
      detail_hub_kiosk_devices: {
        Row: {
          ...
          device_fingerprint_history: string[]
          id: string
          is_active: boolean
          kiosk_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "detail_hub_kiosk_devices_kiosk_id_fkey"
            columns: ["kiosk_id"]
            isOneToOne: false
            referencedRelation: "active_kiosks"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "detail_hub_kiosk_devices_kiosk_id_fkey"
            columns: ["kiosk_id"]
            isOneToOne: false
            referencedRelation: "archived_kiosks"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "detail_hub_kiosk_devices_kiosk_id_fkey"
      ...
      detail_hub_kiosks: {
        Row: {
          ...
          auto_sleep: boolean
          camera_status: Database["public"]["Enums"]["detail_hub_camera_status"]
          created_at: string
          dealership_id: number
          description: string | null
          ...
          status: Database["public"]["Enums"]["detail_hub_kiosk_status"]
          theme: string | null
      ...
      detail_hub_time_entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "detail_hub_time_entries_deleted_by_fkey"
            columns: ["deleted_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      detail_hub_time_entry_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "detail_hub_time_entry_audit_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "detail_hub_time_entry_audit_time_entry_id_fkey"
            columns: ["time_entry_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_currently_working"
            referencedColumns: ["time_entry_id"]
      ...
      invoice_reinvoice_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "invoice_reinvoice_history_child_invoice_id_fkey"
          ...
          {
            foreignKeyName: "invoice_reinvoice_history_parent_invoice_id_fkey"
      ...
      kiosk_recovery_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "kiosk_recovery_log_device_binding_id_fkey"
            columns: ["device_binding_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_kiosk_devices"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "kiosk_recovery_log_device_binding_id_fkey"
            columns: ["device_binding_id"]
            isOneToOne: false
            referencedRelation: "kiosk_devices_with_recovery"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "kiosk_recovery_log_kiosk_id_fkey"
            columns: ["kiosk_id"]
            isOneToOne: false
            referencedRelation: "active_kiosks"
            referencedColumns: ["id"]
      ...
      remote_kiosk_tokens: {
        Row: {
          ...
          short_code: string
          status: Database["public"]["Enums"]["remote_kiosk_token_status"]
          token_hash: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "remote_kiosk_tokens_dealership_id_fkey"
            columns: ["dealership_id"]
            isOneToOne: false
            referencedRelation: "appointment_slots_health"
            referencedColumns: ["dealer_id"]
          ...
          {
            foreignKeyName: "remote_kiosk_tokens_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "detail_hub_currently_working"
            referencedColumns: ["employee_id"]
    ...
    Views: {
      ...
      active_kiosks: {
        Row: {
          ...
          archived_at: string | null
          archived_by: string | null
          auto_sleep: boolean | null
          camera_status:
            | Database["public"]["Enums"]["detail_hub_camera_status"]
            | null
          created_at: string | null
          dealership_id: number | null
          description: string | null
          face_confidence_threshold: number | null
          ...
          require_photo_fallback: boolean | null
          screen_brightness: number | null
          sleep_timeout_minutes: number | null
          status: Database["public"]["Enums"]["detail_hub_kiosk_status"] | null
          theme: string | null
      ...
      detail_hub_employees_with_faces: {
        Row: {
          dealership_id: number | null
          dealership_name: string | null
          descriptor_length: number | null
          employee_number: string | null
          face_enrolled_at: string | null
          face_enrollment_photo_url: string | null
          first_name: string | null
          has_face_enrolled: boolean | null
          id: string | null
          last_name: string | null
          status: string | null
        }
      ...
      kiosk_devices_with_recovery: {
        Row: {
          configured_at: string | null
          created_at: string | null
          device_fingerprint: string | null
          device_fingerprint_history: string[] | null
          id: string | null
          is_active: boolean | null
          kiosk_archived: boolean | null
          kiosk_code: string | null
          kiosk_id: string | null
          kiosk_name: string | null
    ...
    Functions: {
      ...
      archive_kiosk: {
        Args: { p_archived_by: string; p_kiosk_id: string }
        Returns: Json
      }
      ...
      create_reinvoice_from_unpaid: {
        Args: { p_parent_invoice_id: string; p_user_id?: string }
        Returns: string
      }
      ...
      get_active_remote_tokens_for_employee: {
      ...
      log_kiosk_recovery: {
        Args: {
          p_device_binding_id?: string
          p_device_fingerprint: string
          p_error_details?: Json
          p_ip_address?: string
          p_kiosk_id?: string
          p_recovery_method: string
      ...
      revoke_remote_kiosk_token: {
        Args: { p_reason: string; p_revoked_by: string; p_token_id: string }
        Returns: boolean
      }
      ...
      unarchive_kiosk: { Args: { p_kiosk_id: string }; Returns: Json }
    ...
    Enums: {
      ...
      department_type_v2:
        ...
        | "administrative"
        | "management"
      detail_hub_camera_status: "active" | "inactive" | "error"
      detail_hub_invoice_status:
        ...
        | "overdue"
        | "cancelled"
      detail_hub_kiosk_status: "online" | "offline" | "warning" | "maintenance"
      ...
      recon_step_status:
        ...
        | "blocked"
        | "skipped"
      remote_kiosk_token_status: "active" | "used" | "expired" | "revoked"

-- Update the handle_new_user function to accept admin@company.com as well
...
BEGIN
  ...
  VALUES (
    ...
    'dealer',
    CASE WHEN NEW.email IN ('admin@test.com', 'admin@company.com') THEN 'admin' ELSE 'viewer' END
  );
  
  -- If this is the admin user, assign system_admin role and dealer membership
  IF NEW.email IN ('admin@test.com', 'admin@company.com') THEN
    ...
    IF admin_role_id IS NOT NULL THEN
      ...
      -- Create dealer membership for dealer 5

-- Update the handle_new_user function to accept rruiz@mydetailarea.com as admin
...
BEGIN
  ...
  VALUES (
    ...
    'dealer',
    CASE WHEN NEW.email = 'rruiz@mydetailarea.com' THEN 'admin' ELSE 'viewer' END
  );
  
  -- If this is the admin user, assign system_admin role and dealer membership
  IF NEW.email = 'rruiz@mydetailarea.com' THEN

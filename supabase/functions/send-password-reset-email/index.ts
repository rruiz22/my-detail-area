...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const fromAddress = Deno.env.get('EMAIL_FROM_ADDRESS') || 'security@mydetailarea.com';
    ...
    console.log('[PASSWORD RESET EMAIL] Email sent successfully via Resend:', data?.id);

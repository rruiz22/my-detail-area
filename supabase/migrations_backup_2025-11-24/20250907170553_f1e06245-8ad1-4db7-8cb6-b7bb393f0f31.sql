-- Update the handle_new_user function to automatically assign admin role for admin@test.com
...
BEGIN
  ...
  VALUES (
    ...
    'dealer',
    CASE WHEN NEW.email = 'admin@test.com' THEN 'admin' ELSE 'viewer' END
  );

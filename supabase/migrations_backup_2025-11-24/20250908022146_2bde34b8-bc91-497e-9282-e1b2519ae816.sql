-- Fix security issue: Replace temporary RLS policies for dealer_services with proper access controls (v2)

-- Drop all temporary and existing policies for dealer_services
...
DROP POLICY IF EXISTS "Secure view dealer services" ON dealer_services;
DROP POLICY IF EXISTS "Secure create dealer services" ON dealer_services;
DROP POLICY IF EXISTS "Secure update dealer services" ON dealer_services;
DROP POLICY IF EXISTS "Secure delete dealer services" ON dealer_services;

-- Drop all temporary and existing policies for dealer_service_groups  
...
DROP POLICY IF EXISTS "Secure view service groups" ON dealer_service_groups;
DROP POLICY IF EXISTS "Secure manage service groups" ON dealer_service_groups;

-- Create secure RLS policies for dealer_services
CREATE POLICY "Services: Secure view access" 
...
CREATE POLICY "Services: Secure create access" 
...
CREATE POLICY "Services: Secure update access" 
...
CREATE POLICY "Services: Secure delete access" 
...
CREATE POLICY "Service groups: Secure view access" 
...
CREATE POLICY "Service groups: Secure manage access" 

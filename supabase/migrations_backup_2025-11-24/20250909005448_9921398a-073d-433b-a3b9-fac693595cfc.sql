-- Insert 80 test orders across all modules (Sales=sales, Service=service, Recon=service, CarWash=service)

-- Sales Orders (20 orders) - order_type: 'sales'
INSERT INTO orders (
...
-- Service Orders (20 orders) - order_type: 'service'
...
-- Recon Orders (20 orders) - order_type: 'service' but with RECON category in notes
('RC-0001', 'RECON-00001', 'service', 'Trade-In Vehicle', 'recon@dealership.com', '+1-555-0301',
 ...
 'pending', 'normal', '[{"name": "Full Body Inspection", "price": 200, "category": "recon"}, {"name": "Paint Touch-Up", "price": 400, "category": "recon"}, {"name": "Interior Deep Clean", "price": 300, "category": "recon"}]'::jsonb,
 900.00, 'RECON: Trade-in reconditioning assessment', NULL,
...
('RC-0002', 'RECON-00002', 'service', 'Auction Purchase', 'recon@dealership.com', '+1-555-0302',
 ...
 'in_progress', 'high', '[{"name": "Engine Diagnostics", "price": 500, "category": "recon"}, {"name": "Transmission Inspection", "price": 300, "category": "recon"}, {"name": "Electrical System Check", "price": 250, "category": "recon"}]'::jsonb,
 1050.00, 'RECON: Auction vehicle mechanical assessment', NULL,
...
('RC-0003', 'RECON-00003', 'service', 'Lease Return', 'recon@dealership.com', '+1-555-0303',
 ...
 'completed', 'normal', '[{"name": "Wear and Tear Repair", "price": 650, "category": "recon"}, {"name": "Detailing Package", "price": 400, "category": "recon"}, {"name": "Tire Replacement", "price": 800, "category": "recon"}]'::jsonb,
 1850.00, 'RECON: Lease return reconditioning complete', NULL,
...
('RC-0004', 'RECON-00004', 'service', 'CPO Preparation', 'recon@dealership.com', '+1-555-0304',
 ...
 'pending', 'urgent', '[{"name": "170-Point Inspection", "price": 400, "category": "recon"}, {"name": "Warranty Prep", "price": 300, "category": "recon"}, {"name": "Certification Detail", "price": 250, "category": "recon"}]'::jsonb,
 950.00, 'RECON: Certified Pre-Owned preparation', NULL,
 5, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW() + INTERVAL '3 days'),
...
('RC-0005', 'RECON-00005', 'service', 'Wholesale Purchase', 'recon@dealership.com', '+1-555-0305',
 ...
 'in_progress', 'normal', '[{"name": "Collision Assessment", "price": 300, "category": "recon"}, {"name": "Frame Inspection", "price": 200, "category": "recon"}, {"name": "Paint Correction", "price": 800, "category": "recon"}]'::jsonb,
 1300.00, 'RECON: Wholesale vehicle body work assessment', NULL,
...
('RC-0006', 'RECON-00006', 'service', 'Customer Trade', 'recon@dealership.com', '+1-555-0306',
 ...
 'completed', 'normal', '[{"name": "Battery Assessment", "price": 500, "category": "recon"}, {"name": "Electric Motor Check", "price": 300, "category": "recon"}, {"name": "Software Updates", "price": 150, "category": "recon"}]'::jsonb,
 950.00, 'RECON: Electric vehicle recon complete', NULL,
...
('RC-0007', 'RECON-00007', 'service', 'Dealer Exchange', 'recon@dealership.com', '+1-555-0307',
 ...
 'pending', 'high', '[{"name": "Luxury Interior Restoration", "price": 1200, "category": "recon"}, {"name": "Wood Trim Refinishing", "price": 400, "category": "recon"}, {"name": "Leather Conditioning", "price": 300, "category": "recon"}]'::jsonb,
 1900.00, 'RECON: Luxury vehicle interior restoration', NULL,
 5, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', NOW() + INTERVAL '8 days'),

('RC-0008', 'RECON-00008', 'service', 'Service Loaner', 'recon@dealership.com', '+1-555-0308',
...
('RC-0009', 'RECON-00009', 'service', 'Repo Recovery', 'recon@dealership.com', '+1-555-0309',
 ...
 'in_progress', 'urgent', '[{"name": "Damage Assessment", "price": 400, "category": "recon"}, {"name": "Key Replacement", "price": 200, "category": "recon"}, {"name": "Security System Reset", "price": 150, "category": "recon"}]'::jsonb,
 750.00, 'RECON: Repossessed vehicle assessment', NULL,
...
('RC-0010', 'RECON-00010', 'service', 'Fleet Return', 'recon@dealership.com', '+1-555-0310',
 ...
 'completed', 'normal', '[{"name": "High Mileage Service", "price": 800, "category": "recon"}, {"name": "Performance Restoration", "price": 1200, "category": "recon"}, {"name": "Track Wear Assessment", "price": 300, "category": "recon"}]'::jsonb,
 2300.00, 'RECON: Fleet performance vehicle restoration', NULL,
...
('RC-0011', 'RECON-00011', 'service', 'Insurance Recovery', 'recon@dealership.com', '+1-555-0311',
 ...
 'pending', 'normal', '[{"name": "Insurance Damage Repair", "price": 2500, "category": "recon"}, {"name": "Airbag System Check", "price": 400, "category": "recon"}, {"name": "Safety Inspection", "price": 200, "category": "recon"}]'::jsonb,
 3100.00, 'RECON: Insurance claim vehicle repair', NULL,
 5, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', NOW() + INTERVAL '14 days'),

('RC-0012', 'RECON-00012', 'service', 'Demo Vehicle', 'recon@dealership.com', '+1-555-0312',
 2023, 'BMW', 'iX xDrive50', '5UX8V4C03N9I90123', 'RECON012',
 'in_progress', 'high', '[{"name": "Demo Mileage Service", "price": 350, "category": "recon"}, {"name": "Customer Wear Repair", "price": 500, "category": "recon"}, {"name": "Technology Reset", "price": 200, "category": "recon"}]'::jsonb,
 1050.00, 'RECON: Demo vehicle reconditioning', NULL,
...
('RC-0013', 'RECON-00013', 'service', 'Wholesale Flip', 'recon@dealership.com', '+1-555-0313',
 ...
 'completed', 'normal', '[{"name": "Quick Flip Prep", "price": 400, "category": "recon"}, {"name": "Mechanical Safety Check", "price": 250, "category": "recon"}, {"name": "Cosmetic Touch-Up", "price": 300, "category": "recon"}]'::jsonb,
 950.00, 'RECON: Wholesale flip preparation complete', NULL,
...
('RC-0014', 'RECON-00014', 'service', 'Trade Assessment', 'recon@dealership.com', '+1-555-0314',
 ...
 'pending', 'urgent', '[{"name": "Luxury SUV Assessment", "price": 600, "category": "recon"}, {"name": "Third Row Inspection", "price": 200, "category": "recon"}, {"name": "Premium Audio Check", "price": 150, "category": "recon"}]'::jsonb,
 950.00, 'RECON: Large luxury SUV assessment', NULL,
 5, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NOW() + INTERVAL '5 days'),

('RC-0015', 'RECON-00015', 'service', 'Auction Prep', 'recon@dealership.com', '+1-555-0315',
 2019, 'BMW', '318i', 'WBA5R7C50K7R89012', 'RECON015',
 'in_progress', 'normal', '[{"name": "Auction Condition Report", "price": 150, "category": "recon"}, {"name": "Minor Repair Work", "price": 400, "category": "recon"}, {"name": "Documentation Prep", "price": 100, "category": "recon"}]'::jsonb,
 650.00, 'RECON: Auction preparation in progress', NULL,
...
('RC-0017', 'RECON-00017', 'service', 'Lease Damage', 'recon@dealership.com', '+1-555-0317',
 ...
 'pending', 'high', '[{"name": "Excess Wear Repair", "price": 800, "category": "recon"}, {"name": "Interior Restoration", "price": 600, "category": "recon"}, {"name": "Exterior Touch-Up", "price": 400, "category": "recon"}]'::jsonb,
 1800.00, 'RECON: Lease excess wear and tear repair', NULL,
...
('RC-0018', 'RECON-00018', 'service', 'Corporate Fleet', 'recon@dealership.com', '+1-555-0318',
 ...
 'completed', 'normal', '[{"name": "Fleet Vehicle Prep", "price": 350, "category": "recon"}, {"name": "Corporate Branding Removal", "price": 200, "category": "recon"}, {"name": "Interior Sanitization", "price": 100, "category": "recon"}]'::jsonb,
 650.00, 'RECON: Corporate fleet vehicle prep complete', NULL,
...
('RC-0019', 'RECON-00019', 'service', 'Wholesaler Return', 'recon@dealership.com', '+1-555-0319',
 ...
 'in_progress', 'urgent', '[{"name": "Electric Flagship Assessment", "price": 1000, "category": "recon"}, {"name": "High-Tech Systems Check", "price": 500, "category": "recon"}, {"name": "Luxury Component Inspection", "price": 400, "category": "recon"}]'::jsonb,
 1900.00, 'RECON: Electric flagship comprehensive assessment', NULL,
...
('RC-0020', 'RECON-00020', 'service', 'Damage Claim', 'recon@dealership.com', '+1-555-0320',
 ...
 'pending', 'urgent', '[{"name": "Collision Damage Assessment", "price": 1500, "category": "recon"}, {"name": "Carbon Fiber Repair", "price": 2000, "category": "recon"}, {"name": "Performance System Check", "price": 600, "category": "recon"}]'::jsonb,
 4100.00, 'RECON: High-performance vehicle collision repair', NULL,
 5, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW() + INTERVAL '21 days'),

-- Car Wash Orders (20 orders) - order_type: 'service' but with CARWASH category in notes
('CW-0001', 'WASH-00001', 'service', 'Express Customer', 'express@customer.com', '+1-555-0401',
 2023, 'BMW', 'X3', '5UX43DP05O9A12345', 'WASH001',
 'pending', 'normal', '[{"name": "Express Wash", "price": 25, "category": "car_wash"}, {"name": "Basic Vacuum", "price": 10, "category": "car_wash"}]'::jsonb,
 35.00, 'CARWASH: Quick express service', NULL,
 5, NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes', NOW() + INTERVAL '1 hour'),

('CW-0002', 'WASH-00002', 'service', 'Premium Customer', 'premium@customer.com', '+1-555-0402',
 2024, 'BMW', '530i', 'WBA5A7C50P7H89012', 'WASH002',
 'in_progress', 'high', '[{"name": "Premium Wash", "price": 45, "category": "car_wash"}, {"name": "Interior Detail", "price": 35, "category": "car_wash"}, {"name": "Tire Shine", "price": 15, "category": "car_wash"}]'::jsonb,
 95.00, 'CARWASH: Premium service package in wash bay', NULL,
...
('CW-0003', 'WASH-00003', 'service', 'VIP Customer', 'vip@customer.com', '+1-555-0403',
 ...
 'completed', 'urgent', '[{"name": "VIP Full Detail", "price": 120, "category": "car_wash"}, {"name": "Paint Protection", "price": 80, "category": "car_wash"}, {"name": "Interior Protection", "price": 60, "category": "car_wash"}]'::jsonb,
 260.00, 'CARWASH: VIP complete detail service finished', NULL,
 5, NOW() - INTERVAL '2 hours', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '15 minutes'),

('CW-0004', 'WASH-00004', 'service', 'Delivery Prep', 'delivery@dealership.com', '+1-555-0404',
 2024, 'BMW', 'i4', 'WBA4J1C08P5D45678', 'WASH004',
 'pending', 'waiter', '[{"name": "Delivery Wash", "price": 40, "category": "car_wash"}, {"name": "Final Inspection Clean", "price": 20, "category": "car_wash"}]'::jsonb,
 60.00, 'CARWASH: Customer waiting for delivery preparation', NULL,
 5, NOW() - INTERVAL '10 minutes', NOW() - INTERVAL '10 minutes', NOW() + INTERVAL '45 minutes'),

('CW-0005', 'WASH-00005', 'service', 'Service Complete', 'service@dealership.com', '+1-555-0405',
...
('CW-0006', 'WASH-00006', 'service', 'Loaner Return', 'loaner@dealership.com', '+1-555-0406',
...
('CW-0007', 'WASH-00007', 'service', 'Walk-In Customer', 'walkin@customer.com', '+1-555-0407',
 2021, 'BMW', '228i', 'WBA2F1C00M7G78901', 'WASH007',
 'pending', 'waiter', '[{"name": "Basic Wash", "price": 20, "category": "car_wash"}, {"name": "Wax Application", "price": 30, "category": "car_wash"}]'::jsonb,
 50.00, 'CARWASH: Walk-in customer waiting', NULL,
 5, NOW() - INTERVAL '5 minutes', NOW() - INTERVAL '5 minutes', NOW() + INTERVAL '35 minutes'),

('CW-0008', 'WASH-00008', 'service', 'Showroom Prep', 'showroom@dealership.com', '+1-555-0408',
 2024, 'BMW', 'iX', '5UX8V4C03P9I90123', 'WASH008',
 'cancelled', 'normal', '[{"name": "Showroom Detail", "price": 80, "category": "car_wash"}]'::jsonb,
 80.00, 'CARWASH: Vehicle moved to different location', NULL,
 5, NOW() - INTERVAL '3 hours', NOW() - INTERVAL '2 hours', NULL),

('CW-0009', 'WASH-00009', 'service', 'Test Drive Prep', 'testdrive@dealership.com', '+1-555-0409',
...
('CW-0010', 'WASH-00010', 'service', 'Complimentary Service', 'complimentary@customer.com', '+1-555-0410',
...
('CW-0014', 'WASH-00014', 'service', 'Manager Special', 'manager@dealership.com', '+1-555-0414',
 2023, 'BMW', '420i', 'WBA4G7C50O7N45678', 'WASH014',
 'pending', 'waiter', '[{"name": "Manager Special Detail", "price": 75, "category": "car_wash"}, {"name": "Executive Wash", "price": 45, "category": "car_wash"}]'::jsonb,
...
('CW-0017', 'WASH-00017', 'service', 'Customer Pick-up', 'pickup@customer.com', '+1-555-0417',
 2021, 'BMW', 'X2', '5UX2V1C03M9S90123', 'WASH017',
 'pending', 'waiter', '[{"name": "Pick-up Prep Wash", "price": 30, "category": "car_wash"}, {"name": "Final Touch Detail", "price": 20, "category": "car_wash"}]'::jsonb,
 50.00, 'CARWASH: Customer arriving for pickup', NULL,
...
('CW-0019', 'WASH-00019', 'service', 'Executive Demo', 'executive@dealership.com', '+1-555-0419',
...
('CW-0020', 'WASH-00020', 'service', 'Weekend Special', 'weekend@customer.com', '+1-555-0420',
 2023, 'BMW', 'M8', 'WBS2M9C09O5T01234', 'WASH020',
 'pending', 'waiter', '[{"name": "Weekend Special Package", "price": 85, "category": "car_wash"}, {"name": "Premium Plus Detail", "price": 65, "category": "car_wash"}]'::jsonb,
